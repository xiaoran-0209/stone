...
from nets.dlpa_net import Unet
...
if __name__ == "__main__":
    ...
    deep_supervision = False  # 是否深度监督（输出多个结果层）
    # -----------------------------------------------------#
    #   主干网络选择
    #   vgg
    #   resnet50
    ...
    #model_path = ""
  #  model_path="logs/ep005-loss0.407-val_loss0.561.pth"
    # -----------------------------------------------------#
    ...
    with open(os.path.join(VOCdevkit_path, "VOC2007/ImageSets/Segmentation/train.txt"), "r") as f:
        # with open(os.path.join(VOCdevkit_path, "data/Segmentation/train.txt"), "r") as f:
    ...
    if True:
        ...
        optimizer = {
            ...
            # 'adam': AdamW(model.parameters(), lr=Init_lr_fit, betas=(momentum, 0.999), weight_decay=weight_decay,
            #                correct_bias=True),
